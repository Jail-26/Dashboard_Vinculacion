...
// Obtener proyectos y periodos para select
...
if ($_SERVER['REQUEST_METHOD'] == 'POST') {
    ...
    if (empty($nombre_fase) || empty($id_proyecto) || empty($id_periodo)) {
        ...
        $db->query("INSERT INTO fases_proyecto (id_proyecto, id_periodo, nombre_fase, descripcion, estado, comunidad_beneficiaria, cantidad_beneficiados, cantidad_estudiantes, cantidad_profesores, imagen_url, pdf_url) 
                    VALUES (:id_proyecto, :id_periodo, :nombre_fase, :descripcion, :estado, :comunidad_beneficiaria, :cantidad_beneficiados, :cantidad_estudiantes, :cantidad_profesores, :imagen_url, :pdf_url)");
...
<div class="container py-4">
    ...
    <form method="post" enctype="multipart/form-data">
        ...
        <div class="mb-3">
            ...
            <select name="id_periodo" id="id_periodo" class="form-select" required>
                ...
                <?php foreach ($periodos as $periodo): ?>
                    <option value="<?php echo $periodo['id_periodo']; ?>"><?php echo htmlspecialchars($periodo['nombre']); ?></option>
                <?php endforeach; ?>
            </select>
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="cantidad_beneficiados" name="cantidad_beneficiados">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="number" class="form-control" id="cantidad_profesores" name="cantidad_profesores">
        </div>
        ...
        <div class="mb-3">
            ...
            <input type="url" class="form-control" name="pdf_url" placeholder="https://ejemplo.com/fase.pdf">
        </div>
